...
Este diseño cumple el supuesto de Independencia, el cual dice que la selección de un cliente con saldo alto no afecta la probabilidad de seleccionar a otro con saldo bajo. Ademas este diseño considera que el tamaño de la muestra es fijo, que no varia y nosotros podemos obtener una muestra de un tamaño que nos interese.

Realizamos una estimacion de la media poblacional usando a la muestra, obteniendo el valor de 1458.8
