...
\begin{longtable}[t]{lrrrr}
\caption{\label{tab:unnamed-chunk-31}Estimacion de efectos fijos}\\
\toprule
term & estimate & std.error & conf.low & conf.high\\
\midrule
...
\pandocbounded{\includegraphics[keepaspectratio]{Inferencia_Bien_files/figure-pdf/unnamed-chunk-32-1.pdf}}

\begin{longtable}[t]{lllr}
\caption{\label{tab:unnamed-chunk-33}Predicción de éxito para una nueva Campaña Inmobiliaria}\\
\toprule
